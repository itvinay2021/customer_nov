    ...
    <>
      <Modal show={show} onHide={handleClose} centered>
        ...
        <Modal.Body>
          ...
          <Form.Control type="email" placeholder="Enter Coupan" autoFocus />
        </Modal.Body>
        <Modal.Footer>
            ...
            <div>
              <Table responsive>
                ...
                <tbody>
                  ...
                  <tr>
                    <td colSpan={3}>
                      <NavLink to="/Adjust_product" eventKey="link_btn">
              ...
              <div className='bg_row mt-4 p-4'>
                ...
                <Accordion defaultActiveKey="0">
                  <Accordion.Item eventKey="0">
                    <Accordion.Header>Credit, Debit, or ATM Card</Accordion.Header>
                    <Accordion.Body>
                      <Row className="mt-2">
                        <div className="col-sm-12">
                  ...
                  <Accordion.Item eventKey="1">
                    ...
                    <Row className="mt-2">
                        <div className="col-sm-12">
                          ...
                          <Form.Control placeholder="Routing Number" className='mt-3'/>
                          <Form.Select aria-label="Default select example" className="select_color mt-3">
                          ...
                          <Form.Control placeholder="DL Number" className='mt-3'/>
                          <Form.Select aria-label="Default select example" className="select_color mt-3">
                  ...
                  <Accordion.Item eventKey="2">
                    ...
                    <Row className="">
                        <div className="col-sm-12">
                          <Form.Control placeholder="Amount" className='mt-2'/>
                          <Form.Control placeholder="Approval Number" className='mt-3'/>
                        </div>
                      </Row>
                    </Accordion.Body>
                  </Accordion.Item>
                  <Accordion.Item eventKey="3">
                    ...
                    <Row className="">
                        <div className="col-sm-12">
                          <Form.Control placeholder="Amount" className='mt-2'/>
                          <Form.Control placeholder="Approval Number" className='mt-3'/>
                          <button className="btn_green py-2 px-4 text-center mt-3">Get Balance</button>
                        </div>
                      </Row>
                    </Accordion.Body>
                  </Accordion.Item>
                  ...
                  <Accordion.Item eventKey="5">
                    ...
                    <Accordion.Body>
                    <Form.Control placeholder="Amount" className='mt-2'/>
                    <Form.Control placeholder="Card Number" className='mt-3'/>
                    </Accordion.Body>
                  </Accordion.Item>
                  <Accordion.Item eventKey="6">
                    <Accordion.Header> Gift Card</Accordion.Header>
                    <Accordion.Body>
                    <Form.Control placeholder="Gift Card Number" className='mt-2'/>
                    <button className="btn_green py-2 px-4 text-center mt-3">Get Balance</button>
                    </Accordion.Body>
                  </Accordion.Item>
                </Accordion>
            ...
            <div className='usercoment mx-2 rounded mt-5'>
              <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
                ...
                <div className='float-end mt-5'>
                  <button className="btn_blue py-2 px-4 mt-2 r_w-100 r_ms-0">Copy link</button>
                  <button className="btn_blue py-2 px-4 ms-2 mt-2 r_w-100 r_ms-0">Send Invoice</button>
                  <button className="btn_green py-2 px-4 ms-2 mt-2 r_w-100 r_ms-0">Validate Address</button>
                  <button className="btn_green py-2 px-4 ms-2 mt-2 r_w-100 r_ms-0">Save invoice</button>
                  <button className="btn_green py-2 px-4 ms-2 mt-2 r_w-100 r_ms-0">Process payment</button>
                </div>
              </Form.Group>
            </div>
          </div>
